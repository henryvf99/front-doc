...
export class ListRegidoresComponent {
  ...
  ngOnInit() {
    ...
    this.user_id = this.regidoresService.authService.user.id;
  ...
  private getTableData(): void {
    ...
    this.regidoresService.getPlanillaTipoTrabajador(this.idtipotrabajador).subscribe((resp:any) => {
  ...
  deletePlanilla(casdirectivosb_id: string) {
    this.regidoresService.deletePlanilla(casdirectivosb_id).subscribe((res: any) => {
