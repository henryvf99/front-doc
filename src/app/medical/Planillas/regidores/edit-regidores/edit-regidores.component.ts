...
export class EditRegidoresComponent {
  ...
  ngOnInit(): void {
    ...
    this.regidoresService.listPlanillaById(this.planilla_id).subscribe((resp:any) => {
      console.log(resp);
  ...
  save(){
    ...
    this.regidoresService.updatePlanilla(this.planilla_id, formData).subscribe((resp:any) => {
      console.log(resp);
