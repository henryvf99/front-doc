...
export class EditCasindeterminadosComponent {
  ...
  ngOnInit(): void {
    ...
    this.casindeterminadosService.listPlanillaById(this.planilla_id).subscribe((resp:any) => {
      console.log(resp);
  ...
  save(){
    ...
    this.casindeterminadosService.updatePlanilla(this.planilla_id, formData).subscribe((resp:any) => {
      console.log(resp);
