...
export class AddCasindeterminadosComponent implements OnInit{
  ...
  private idtipotrabajador = "6614ddd272fa497e6831fdbe";
  ...
  ngOnInit(): void {
    ...
    this.casindeterminadosService.listMonths().subscribe((resp:any) => {
      this.months = resp.data;
    })

    this.casindeterminadosService.listTipoTrabajador().subscribe((resp:any) => {
  ...
  save(){
    ...
    this.casindeterminadosService.registrarPlanilla(formData).subscribe((res:any) => {
  ...
  mostrarMensajeDeExito() {
    Swal.fire({
      ...
      this.router.navigateByUrl('/casindeterminados/list-casindeterminados');
    });
  }
