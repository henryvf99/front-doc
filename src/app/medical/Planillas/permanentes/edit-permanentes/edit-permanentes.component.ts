...
export class EditPermanentesComponent {
  ...
  ngOnInit(): void {
    ...
    this.permanentesService.listPlanillaById(this.planilla_id).subscribe((resp:any) => {
      console.log(resp);
  ...
  save(){
    ...
    this.permanentesService.updatePlanilla(this.planilla_id, formData).subscribe((resp:any) => {
      console.log(resp);
