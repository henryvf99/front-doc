...
export class ListNombradosComponent {
  ...
  private getTableData(): void {
    ...
    this.nombradosService.getPlanillaTipoTrabajador(this.idtipotrabajador).subscribe((resp:any) => {
  ...
  deletePlanilla(casdirectivosb_id: string) {
    this.nombradosService.deletePlanilla(casdirectivosb_id).subscribe((res: any) => {
      console.log(res);
      if(res.success){
