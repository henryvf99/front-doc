...
export class EditNombradosComponent {
  ...
  ngOnInit(): void {
    ...
    this.nombradosService.listPlanillaById(this.planilla_id).subscribe((resp:any) => {
  ...
  save(){
    ...
    this.nombradosService.updatePlanilla(this.planilla_id, formData).subscribe((resp:any) => {
