...
export class ListPensionistasComponent {
  ...
  private getTableData(): void {
    ...
    this.pensionistasService.getPlanillaTipoTrabajador(this.idtipotrabajador).subscribe((resp:any) => {
  ...
  deletePlanilla(casdirectivosb_id: string) {
    this.pensionistasService.deletePlanilla(casdirectivosb_id).subscribe((res: any) => {
