...
export class AddReposijudicialComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    this.user_id = this.reposijudicialService.authService.user.id;
    this.listUser(this.user_id);
    
    this.reposijudicialService.listYears().subscribe((resp:any) => {
      this.years = resp.data;
    })

    this.reposijudicialService.listMonths().subscribe((resp:any) => {
      this.months = resp.data;
    })

    this.reposijudicialService.listTipoTrabajador().subscribe((resp:any) => {
  ...
  save(){
    ...
    this.reposijudicialService.registrarPlanilla(formData).subscribe((res:any) => {
  ...
  mostrarMensajeDeExito() {
    Swal.fire({
      ...
      this.router.navigateByUrl('/reposijudicial/list-reposijudicial');
    });
  }
}
