...
export class ListReposijudicialComponent {
  ...
  private getTableData(): void {
    ...
    this.reposijudicialService.getPlanillaTipoTrabajador(this.idtipotrabajador).subscribe((resp:any) => {
  ...
  deletePlanilla(casdirectivosb_id: string) {
    this.reposijudicialService.deletePlanilla(casdirectivosb_id).subscribe((res: any) => {
      console.log(res);
      if(res.success){
