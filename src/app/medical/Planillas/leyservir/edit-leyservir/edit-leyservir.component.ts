...
export class EditLeyservirComponent {
  ...
  ngOnInit(): void {
    ...
    this.leyservirService.listPlanillaById(this.planilla_id).subscribe((resp:any) => {
      console.log(resp);
  ...
  save(){
    ...
    this.leyservirService.updatePlanilla(this.planilla_id, formData).subscribe((resp:any) => {
      console.log(resp);
