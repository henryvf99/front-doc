...
export class AditExfuncionariosComponent {
  ...
  ngOnInit(): void {
    ...
    this.exfuncionariosService.listTrabajadorById(this.trabajador_id).subscribe((resp:any) => {
  ...
  save(){
    ...
    this.exfuncionariosService.updateTrabajador(this.trabajador_id, data).subscribe((res:any) => {
