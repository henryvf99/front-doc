...
export class EditRequerimientosComponent {
  ...
  ngOnInit(): void {
    ...
    this.user_id = this.requerimientosService.authService.user.id;
    ...
    this.requerimientosService.listYears().subscribe((resp:any) => {
      this.years = resp.data;
    })

    this.requerimientosService.listMonths().subscribe((resp:any) => {
      this.months = resp.data;
    })

    this.requerimientosService.listTipoDocumento().subscribe((resp:any) => {
      this.tipodocumentos = resp.data;
    })

    this.requerimientosService.listEmitidosById(this.documento_id).subscribe((resp:any) => {
  ...
  save(){
    ...
    this.requerimientosService.updateEmitidos(this.documento_id,formData).subscribe((resp:any) => {
  ...
  mostrarMensajeDeExito() {
    Swal.fire({
      ...
      this.router.navigateByUrl('/requerimientos/list-requerimientos');
    });
  }
