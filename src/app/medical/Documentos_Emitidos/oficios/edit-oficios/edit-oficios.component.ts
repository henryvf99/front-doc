...
export class EditOficiosComponent {
  ...
  ngOnInit(): void {
    ...
    this.oficiosService.listEmitidosById(this.documento_id).subscribe((resp:any) => {
      console.log(resp);
  ...
  save(){
    ...
    this.oficiosService.updateEmitidos(this.documento_id,formData).subscribe((resp:any) => {
      console.log(resp);
